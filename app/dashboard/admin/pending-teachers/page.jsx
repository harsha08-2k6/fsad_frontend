...
import { GraduationCap, CheckCircle, XCircle, Loader2, UserX } from "lucide-react";
    ...
    return (
        <div className="space-y-8 animate-in fade-in duration-500">
            <div className="page-header mb-8">
                ...
                <p className="page-subtitle">Review and approve new teacher registration requests.</p>
            </div>
                            ...
                            {loading ? (
                                ...
                                <tr>
                                    <td colSpan="4" className="px-6 py-24 text-center">
                                        <div className="flex flex-col items-center justify-center opacity-40">
                                            ...
                                            <p className="text-lg font-medium">No pending teacher applications</p>
                                        </div>
                                    </td>
                                </tr>
                            ) : (
                                teachers.map((teacher) => (
                                    <tr key={teacher.id} className="hover:bg-gray-50/30 transition-colors">
                                        ...
                                        <td className="px-6 py-4 text-sm text-gray-500">
                                            {new Date(teacher.created_at || teacher.createdAt).toLocaleDateString()}
                                        </td>
